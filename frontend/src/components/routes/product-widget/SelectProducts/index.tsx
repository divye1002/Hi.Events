...
const SelectProducts = (props: SelectProductsProps) => {
    ...
    return (
        <div className={'hi-product-widget-container'}
            ...
            <div class="terms">
                <p>
                    Welcome to <a href="https://summit.skoch.in" target="_blank" rel="noopener noreferrer">summit.skoch.in</a>. Skoch Consultancy Services Pvt Ltd (“SKOCH”) provides this site to you subject to the following conditions. By visiting the <a href="https://summit.skoch.in" target="_blank" rel="noopener noreferrer">summit.skoch.in</a> site (the “Site”), you accept these conditions. Please read them carefully. In addition, when you use any current or future SKOCH service or business, you also will be subject to the guidelines, terms and agreements applicable to such service or business.
                </p>
                <p>
